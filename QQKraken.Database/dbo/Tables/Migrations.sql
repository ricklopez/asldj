CREATE TABLE [dbo].[Migrations] (
    ...
    [IsPhase1]                BIT            CONSTRAINT [DF_Migrations_IsPhase1] DEFAULT ((0)) NOT NULL,
    ...
    [DefaultPolicyEffective]  DATETIME2 (7)  CONSTRAINT [DF_Migrations_DefaultPolicyEffective] DEFAULT ('1/1/1900') NOT NULL,
    [DefaultPolicyExpiration] DATETIME2 (7)  CONSTRAINT [DF_Migrations_DefaultPolicyExpiration] DEFAULT ('1/1/1900') NOT NULL,
